...
function useSize(element) {
  const [size4, setSize] = React11.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow4, setArrow] = React12.useState(null);
...
var RemoveScroll = React23.forwardRef(function(props, parentRef) {
  ...
  return React23.createElement(
    React23.Fragment,
    null,
    enabled && React23.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React28.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React28.useState(false);
  ...
  const triggerPointerDownPosRef = React28.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React28.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime10.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React28.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React28.useCallback((option) => {
...
var SelectTrigger = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React28.useRef("touch");
...
var SelectValue = React28.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React28.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, children, ...iconProps } = props;
    return (0, import_jsx_runtime10.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectContent = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const [fragment, setFragment] = React28.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React28.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [viewport, setViewport] = React28.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React28.useState(null);
    const [selectedItemText, setSelectedItemText] = React28.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React28.useState(false);
    const firstValidItemFoundRef = React28.useRef(false);
    React28.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React28.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React28.useCallback(
    ...
    const itemRefCallback = React28.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React28.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React28.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React28.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React28.useState(null);
  const [content, setContent] = React28.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React28.useRef(false);
  const shouldRepositionRef = React28.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React28.useCallback(() => {
  ...
  const handleScrollButtonChange = React28.useCallback(
    (node) => {
...
var SelectPopperPosition = React28.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React28.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React28.useRef(0);
...
var SelectGroup = React28.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props;
    const groupId = useId();
    return (0, import_jsx_runtime10.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime10.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React28.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime10.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React28.useCallback((node) => {
...
var SelectItemText = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React28.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React28.useMemo(
    ...
    return (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
      (0, import_jsx_runtime10.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React28.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...itemIndicatorProps } = props;
    const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME, __scopeSelect);
    return itemContext.isSelected ? (0, import_jsx_runtime10.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME;
var SCROLL_UP_BUTTON_NAME = "SelectScrollUpButton";
var SelectScrollUpButton = React28.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React28.useState(false);
...
var SelectScrollDownButton = React28.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React28.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React28.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React28.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React28.useCallback(() => {
...
var SelectSeparator = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
SelectSeparator.displayName = SEPARATOR_NAME;
var ARROW_NAME2 = "SelectArrow";
var SelectArrow = React28.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React28.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React28.useRef("");
  const timerRef = React28.useRef(0);
  const handleTypeaheadSearch = React28.useCallback(
    (key) => {
  ...
  const resetTypeahead = React28.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React28.useEffect(() => {
